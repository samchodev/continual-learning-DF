...
class DFNet:
    ...
    def build(input_shape, classes):
        ...
        # kernel_size = ['None', 16, 16, 16, 16, 16]
        ...
        model.add(Dropout(0.3, name='block1_dropout'))
        ...
        model.add(Dropout(0.3, name='block3_dropout'))
        ...
        model.add(Dropout(0.3, name='block4_dropout'))
        ...
        model.add(Dropout(0.3, name='block5_dropout'))
